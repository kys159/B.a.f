...
library(RSelenium)
name<-read.csv("C:/Users/82104/Desktop/2주차크롤링/example.csv",header=F,stringsAsFactors = F)
str(name)
...
#블로그 클릭
blogButton<-remDr$findElement(using="xpath",value='//*[@id="NM_FAVORITE"]/div[1]/ul[1]/li[3]/a')
